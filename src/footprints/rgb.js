module.exports = {
    ...
    body: p => {
    function standard(font_effect) { 
        return `
        (module WS2812B (layer F.Cu) (tedit 53BEE615)
            ${p.at /* parametric position */}

            ${'' /* footprint reference */}
            (fp_text reference "${p.ref}" (at 0 0) (layer ${p.param.side}.SilkS) ${p.ref_hide} (effects (font (size 1.27 1.27) (thickness 0.15) ${font_effect})))
            (fp_text value "" (at 0 0) (layer ${p.param.side}.SilkS) hide (effects (font (size 1.27 1.27) (thickness 0.15) ${font_effect})))
