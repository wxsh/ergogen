    ...
    body: p => {
      ...
      function pins(def_neg, def_pos, def_side) {
        if(p.param.hotswap) {
          return `
          ${'' /* holes */}
          (pad "" thru_hole circle (at ${def_pos}2.54 -5.08) (size 3 3) (drill 3) (layers *.Cu *.Mask))
          (pad "" thru_hole circle (at ${def_neg}3.81 -2.54) (size 3 3) (drill 3) (layers *.Cu *.Mask))
          (pad "" thru_hole circle (at 0 -8.55) (size 0.6 0.6) (drill 0.3) (layers *.Cu *.Mask) ${p.net.to.str})
          
          ${'' /* net pads */}
          (pad 1 smd rect (at ${def_neg}7.085 -2.54 ${p.rot}) (size 2.55 2.5) (layers ${def_side}.Cu ${def_side}.Paste ${def_side}.Mask) ${p.net.from.str})
          (pad 2 smd custom (at ${def_pos}5.842 -5.08 ${p.rot}) (size 2.55 2.5) (layers ${def_side}.Cu ${def_side}.Paste ${def_side}.Mask) ${p.net.to.str}
          (zone_connect 0)
          (options (clearance outline) (anchor rect))
          (primitives
            (gr_line (start 0 0) (end 0 -2.5) (width 0.25))
            (gr_line (start 0 -2.5) (end ${def_neg}1 -3.5) (width 0.25))
            (gr_line (start ${def_neg}1 -3.5) (end ${def_neg}5.75 -3.5) (width 0.25))
          ))
          `
        } else {
            return `
